...
def bollettino_mensile(anno=None, mese=None, dati=None):
    ...
    doc = SimpleDocTemplate("%2i%02i Mensile.pdf" % (anno - 2000, mese), topMargin=2 * cm,
                            bottomMargin=0.7 * cm)
    style = styles["Normal"]
...
def bollettino_pioggia(anno=0, mese=0, dati=None):
    styles = getSampleStyleSheet()
    ...
    doc = SimpleDocTemplate("%2i%02i Pioggia.pdf" % (anno - 2000, mese), topMargin=2 * cm,
                            bottomMargin=0.7 * cm)
    style = styles["Normal"]
    pdfmetrics.registerFont(TTFont('Arial', 'ARIAL.TTF'))
